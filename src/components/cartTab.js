    ...
    >
      ...
      {carts.length > 0 && (
        <div className="p-4 flex justify-between items-center bg-gray-800 border-t-2 border-gray-600">
          ...
          <button
            className="text-white text-xl font-bold bg-red-500 p-2 rounded-lg shadow-lg"
      ...
      <div className="grid grid-cols-2">
        <button
          className="bg-black text-xl font-bold p-2 text-white"
        ...
        <button
          className="bg-amber-600 text-xl font-bold p-2 text-white"
